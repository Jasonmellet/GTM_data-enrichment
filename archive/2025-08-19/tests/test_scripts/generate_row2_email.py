#!/usr/bin/env python3
"""
Generate three emails for row 2 only - AbiMar Foods / Jeanalyn Leyco.
"""
...
def generate_row2_email():
    """Generate three emails for row 2 only."""
    print("📧 Generating Three Emails for Row 2 (AbiMar Foods)")
    print("=" * 60)
    ...
    try:
        ...
        print(f"📊 Processing Row {idx + 1}: {company_name}")
        ...
        try:
            # Create focused prompt for row 2
...
CTA: [CTA text]"""
            ...
            if response.choices and len(response.choices) > 0:
                ...
                if emails:
                    # Write emails to columns BA-BM (indices 53-64) for row 2
        ...
        print(f"\n🎉 Email generation completed for Row 2!")
        print(f"🔍 Check your Google Sheet - Row 2, Columns BA-BM should now contain three cold emails")
