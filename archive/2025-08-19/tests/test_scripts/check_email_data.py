#!/usr/bin/env python3
"""
Check what email data has been written to the spreadsheet and verify content.
"""

from google_sheets_handler import GoogleSheetsHandler

def check_email_data():
    """Check the email data in columns BA-BM for rows 2, 3, and 4."""
    print("🔍 Checking Email Data in Spreadsheet")
    print("=" * 50)
