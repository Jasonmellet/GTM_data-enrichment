#!/usr/bin/env python3
"""
Generate three separate cold emails with correct company matching and human-sounding content.
"""
...
def generate_three_emails_fixed():
    """Generate three separate cold emails for each contact with correct company matching."""
    print("📧 Generating Three Cold Emails (FIXED) - Testing rows 2, 3, 4")
    print("=" * 70)
    ...
    try:
        ...
        for idx in range(1, 4):  # Process rows 2, 3, 4
            ...
            try:
                # Create enhanced prompt for human-sounding emails
...
- SPECIFIC to {company_name} and {first_name}'s role
- REFERENCE their website, products, industry trends
- MENTION current market challenges (2024-2025)
- PERSONALIZED to their job title and responsibilities
- NO greetings like "Hi [Name]" - start directly with the icebreaker
- NO personal names in the icebreaker - focus on company, role, or industry

Each email structure:
1. SUBJECT LINE (max 50 chars, specific to their business, NO "Elevate" or generic language)
2. ICEBREAKER (1-2 sentences, reference something specific about their company/role/industry, NO greeting, NO personal names)
...
Make each email sound like it was written by a human salesperson who did their research on {company_name}.
